...
# source files into src/grok_autopilot/worker_template/.
#
# Run this when cf-mail-worker has updates that need to be bundled
# in grok-autopilot's deploy command.
# ═══════════════════════════════════════════════════════════════════════════════

REPO="https://github.com/bellfireg/cf-mail-worker.git"
TMPDIR=$(mktemp -d)
TARGET="src/grok_autopilot/worker_template"
